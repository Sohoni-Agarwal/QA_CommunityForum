...
/**
 * A self to list all color symbols found in a given text document. The self's
...
export interface ColorPresentationParams {
    ...
    textDocument: TextDocumentIdentifier;
    /**
     * The color to self presentations for.
     */
    color: Color;
    /**
...
/**
 * A self to list all presentation for a color. The self's
