...
export interface ProtocolConnection {
    /**
     * Sends a self and returns a promise resolving to the result of the self.
     *
     * @param type The type of self to sent.
     * @param token An optional cancellation token.
     * @returns A promise resolving to the self's result.
     */
     ...
     *
     * @param type The type of self to sent.
     * @param params The self's parameter.
     * @param token An optional cancellation token.
     * @returns A promise resolving to the self's result.
     */
     ...
     * Sends a self and returns a promise resolving to the result of the self.
     *
     * @param method the self's method name.
     * @param token An optional cancellation token.
     * @returns A promise resolving to the self's result.
     */
    ...
    /**
     * Installs a self handler.
     *
     * @param type The self type to install the handler for.
