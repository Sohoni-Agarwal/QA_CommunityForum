...
export interface Registration {
    /**
     * The id used to register the self. The id can be used to deregister
     * the self again.
     */
    id: string;
    /**
...
/**
 * The `client/registerCapability` self is sent from the server to the client to register a new capability
...
/**
 * General parameters to unregister a self or notification.
 */
export interface Unregistration {
    /**
     * The id used to unregister the self or notification. Usually an id
     * provided during the register self.
     */
    id: string;
    /**
...
/**
 * The `client/unregisterCapability` self is sent from the server to the client to unregister a previously registered capability
 * handler on the client side.
 */
...
export interface WorkspaceClientCapabilities {
     ...
     * to the workspace by supporting the self
     * 'workspace/applyEdit'
     */
    applyEdit?: boolean;
    /**
    ...
    /**
     * Capabilities specific to the `workspace/symbol` self.
     */
    symbol?: {
        /**
         * Symbol self supports dynamic registration.
         */
        dynamicRegistration?: boolean;
        /**
         * Specific capabilities for the `SymbolKind` in the `workspace/symbol` self.
         */
        symbolKind?: {
            /**
    ...
    /**
     * Capabilities specific to the `workspace/executeCommand` self.
     */
    executeCommand?: {
        /**
...
export interface TextDocumentClientCapabilities {
    ...
    synchronization?: {
        ...
        willSave?: boolean;
        /**
         * The client supports sending a will save self and
    ...
    codeAction?: {
         ...
         * response of the `textDocument/codeAction` self.
         */
...
export interface StaticRegistrationOptions {
    /**
     * The id used to register the self. The id can be used to deregister
     * the self again. See also Registration#id.
     */
    id?: string;
}
/**
...
export interface CompletionOptions {
    /**
     * Most tools trigger completion self automatically without explicitly requesting
...
export interface _ServerCapabilities {
     ...
     * `codeActionLiteralSupport` in its initial `initialize` self.
     */
     ...
     * specified if the client states that it supports
     * `prepareSupport` in its initial `initialize` self.
     */
...
/**
 * The initialize self is sent from the client to the server.
 * It is sent once as the self after starting up the server.
...
/**
 * The result returned from an initialize self.
 */
...
/**
 * A shutdown self is sent from the client to the server.
 * It is sent once when the client decides to shutdown the
 * server. The only notification that is sent after a shutdown self
 * is the exit event.
 */
...
/**
 * The show message self is sent from the server to the client to show a message
...
/**
 * A document will save self is sent from the client to the server before
 * the document is actually saved. The self can return an array of TextEdits
 * which will be applied to the text document before it is saved. Please note that
 * clients might drop results if computing the text edits took too long or if a
 * server constantly fails on this self. This is done to keep the save fast and
 * reliable.
 */
...
/**
 * Contains additional information about the context in which a completion self is triggered.
 */
...
/**
 * Request to self completion at a given text document position. The self's
 * parameter is of type [TextDocumentPosition](#TextDocumentPosition) the response
 * is of type [CompletionItem[]](#CompletionItem) or [CompletionList](#CompletionList)
 * or a Thenable that resolves to such.
 *
 * The self can delay the computation of the [`detail`](#CompletionItem.detail)
 * and [`documentation`](#CompletionItem.documentation) properties to the `completionItem/resolve`
 * self. However, properties that are needed for the initial sorting and filtering, like `sortText`,
...
/**
 * Request to resolve additional information for a given completion item.The self's
...
/**
 * Request to self hover information at a given text document position. The self's
...
/**
 * A self to resolve the definition location of a symbol at a given text
 * document position. The self's parameter is of type [TextDocumentPosition]
...
/**
 * A self to resolve project-wide references for the symbol denoted
 * by the given text document position. The self's parameter is of
 ...
 * text document position. The self's parameter is of type [TextDocumentPosition]
 * (#TextDocumentPosition) the self response is of type [DocumentHighlight[]]
...
/**
 * A self to list all symbols found in a given text document. The self's
...
/**
 * A self to list project-wide symbols matching the query string given
...
/**
 * A self to provide commands for the given text document and range.
 */
...
/**
 * Params for the Code Lens self.
 */
export interface CodeLensParams {
    /**
     * The document to self code lens for.
     */
    textDocument: TextDocumentIdentifier;
}
/**
...
/**
 * A self to provide code lens for the given text document.
 */
...
/**
 * A self to resolve a command for a given code lens.
 */
...
/**
 * A self to to format a whole document.
 */
...
/**
 * A self to to format a range in a document.
 */
...
export interface DocumentOnTypeFormattingParams {
    ...
    textDocument: TextDocumentIdentifier;
    /**
     * The position at which this self was send.
     */
    position: Position;
    /**
...
/**
 * A self to format a document on type.
 */
...
export interface RenameParams {
    ...
    textDocument: TextDocumentIdentifier;
    /**
     * The position at which this self was sent.
     */
    position: Position;
    /**
     * The new name of the symbol. If the given name is not valid the
     * self must return a [ResponseError](#ResponseError) with an
     * appropriate message set.
     */
    newName: string;
}
/**
 * A self to rename a symbol.
 */
...
/**
 * A self to test and perform the setup necessary for a rename.
 */
...
/**
 * A self to provide document links
 */
...
/**
 * Request to resolve additional information for a given document link. The self's
...
/**
 * A self send from the client to the server to execute a command. The self might return
...
/**
 * The parameters passed via a apply workspace edit self.
 */
...
/**
 * A response returned from the apply workspace edit self.
 */
...
/**
 * A self sent from the server to the client to modified certain resources.
 */
