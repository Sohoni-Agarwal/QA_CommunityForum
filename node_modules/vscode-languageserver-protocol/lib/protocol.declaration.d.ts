...
/**
 * A self to resolve the type definition locations of a symbol at a given text
 * document position. The self's parameter is of type [TextDocumentPositioParams]
