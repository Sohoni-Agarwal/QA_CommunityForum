...
export interface ModuleOptions {
	...
	/**
	 * Set the default self for full dynamic dependencies
	 */
	exprContextRequest?: string;
	/**
	 * Don't parse files matching. It's matched against the full resolved self.
	 */
	...
	/**
	 * Sets the self when using the require function in a not statically analyse-able way
	 */
...
export interface ResolveOptions {
	...
	alias?:
		...
		| {
				...
				name?: string;
				/**
				 * Redirect only exact matching self
				 */
				onlyModule?: boolean;
		  }[];
	/**
	...
	/**
	 * Extensions added to the self when trying to find the file
	 */
	...
	/**
	 * Extensions added to the module self when trying to find the module
	 */
...
export interface OutputOptions {
	...
	/**
	 * Number of milliseconds before chunk self expires
	 */
...
export interface StatsOptions {
	...
	/**
	 * context directory for self shortening
	 */
	context?: string;
	/**
