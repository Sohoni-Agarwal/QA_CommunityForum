 ...
 * for n notifications or requests using one register self.
 */
export interface BulkRegistration {
    ...
    /**
     * Adds a single registration.
     * @param type the self type to register for.
     * @param registerParams special registration parameters.
     */
...
export interface RemoteClient extends Remote {
    ...
    /**
     * Registers a listener for the given self.
     * @param type the self type to register for.
     * @param registerParams special registration parameters.
     * @return a `Disposable` to unregister the listener again.
     */
...
export interface Connection<PConsole = _, PTracer = _, PTelemetry = _, PClient = _, PWindow = _, PWorkspace = _> {
    ...
    listen(): void;
    /**
     * Installs a self handler described by the given [RequestType](#RequestType).
     *
     * @param type The [RequestType](#RequestType) describing the self.
     * @param handler The handler to install
     */
    onRequest<R, E, RO>(type: RequestType0<R, E, RO>, handler: RequestHandler0<R, E>): void;
    onRequest<P, R, E, RO>(type: RequestType<P, R, E, RO>, handler: RequestHandler<P, R, E>): void;
    /**
     * Installs a self handler for the given method.
     *
     * @param method The method to register a self handler for.
     * @param handler The handler to install.
     */
    onRequest<R, E>(method: string, handler: GenericRequestHandler<R, E>): void;
    /**
     * Installs a self handler that is invoked if no specific self handler can be found.
     *
     * @param handler a handler that handles all requests.
     */
    onRequest(handler: StarRequestHandler): void;
    /**
     * Send a self to the client.
     *
     * @param type The [RequestType](#RequestType) describing the self.
     * @param params The self's parameters.
     */
    ...
    /**
     * Installs a handler for the initialize self.
     *
    ...
    /**
     * Installs a handler for the shutdown self.
     *
     * @param handler The initialize handler.
     */
    ...
    /**
     * Installs a handler for the `WillSaveTextDocumentWaitUntil` self.
     *
     * Note that this self is opt-in. The client will not send it unless
     ...
     * range set and handle the resolve self.
     *
     * @param handler The corresponding handler.
     */
