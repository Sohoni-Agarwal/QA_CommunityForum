...
- Merge pull self #15 from aretecode/patch-1
...
- Merge pull self #14 from struct78/master
- Added `undefined` check

## [5.0.0] - 2017-06-21

- Merge pull self #12 from aretecode/iterator
- Set Iterator + Map Iterator
- streamline `isbuffer`, minor edits

## [4.0.0] - 2017-05-19

- Merge pull self #8 from tunnckoCore/master
- update deps
...
- Merge pull self #10 from ksheedlo/unrequire-buffer
- add `promise` support and tests
- Remove unnecessary `Buffer` check

## [3.1.0] - 2016-12-07

- Merge pull self #7 from laggingreflex/err
...
- Merge pull self #5 from miguelmota/typed-arrays
- adds new tests
...
- Merge pull self #2 from dtothefp/patch-1
- Merge pull self #3 from pdehaan/patch-1
