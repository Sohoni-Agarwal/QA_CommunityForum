 ...
 *   - Validating a GraphQL self against a type schema.
 *   - Executing a GraphQL self against a type schema.
 *
...
export { version, versionInfo } from './version'; // The primary entry point into fulfilling a GraphQL self.
