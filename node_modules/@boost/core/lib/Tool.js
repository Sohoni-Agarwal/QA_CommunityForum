...
class Tool extends Emitter_1.default {
    ...
    getWorkspacePackages(options = {}) {
        ...
        return fast_glob_1.default
            ...
            .map(filePath => ({
            ...fs_extra_1.default.readJsonSync(filePath),
    ...
    getWorkspacePackagePaths(options = {}) {
        const root = options.root || this.options.root;
        return fast_glob_1.default.sync(this.getWorkspacePaths({ ...options, relative: true, root }), {
    ...
    initialize() {
        ...
        this.debug('Initializing %s application', internal_1.color.toolName(appName));
    ...
    registerPlugin(typeName, contract, options = {}) {
        ...
        this.debug('Registering new plugin type: %s', internal_1.color.pluginName(name));
