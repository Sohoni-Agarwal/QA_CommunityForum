...
class Reporter extends Plugin_1.default {
    ...
    getColorPalette() {
        ...
        if (chalk_1.default.level >= 2 && theme !== 'default') {
            try {
    ...
    hasColorSupport(level = 1) {
        return chalk_1.default.enabled && chalk_1.default.supportsColor.level >= level;
    }
    /**
     * Hide the console cursor.
     */
    hideCursor() {
        this.console.out(ansi_escapes_1.default.cursorHide);
     ...
     */
    resetCursor() {
        this.console.out(ansi_escapes_1.default.cursorTo(0, this.size().rows));
        return this;
    }
    /**
     ...
     */
    showCursor() {
        this.console.out(ansi_escapes_1.default.cursorShow);
        return this;
    }
    /**
     ...
     */
    strip(message) {
        return strip_ansi_1.default(message);
    }
    /**
    ...
    style(message, type = 'default', modifiers = []) {
        ...
        let out = color.charAt(0) === '#' ? chalk_1.default.hex(color) : chalk_1.default[color];
    ...
    truncate(message, columns, options) {
        return cli_truncate_1.default(message, columns || this.size().columns, options);
    }
    /**
     * Wrap a string that contains ANSI escape characters to a specific column width.
     */
    wrap(message, columns, options) {
        return wrap_ansi_1.default(message, columns || this.size().columns, {
            hard: true,
            trim: false,
            ...options,
        });
