...
import { Locale, Translator, Format } from './types';
...
export default function createTranslator(namespace: string | string[], resourcePath: Path | Path[], { autoDetect, debug: debugOpt, fallbackLocale, locale, lookupType, resourceFormat, }?: TranslatorOptions): Translator;
