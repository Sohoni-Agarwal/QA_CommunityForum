                ...
                return [
                    {
                        ...
                        task: async (ctx, task) => {
                            ...
                            const { compositionValidationResult, checkSchemaResult } = await project.engine.checkPartialSchema({
                                id: graphName,
                                graphVariant: tag,
                            ...
                            task.title = `Found ${utils_1.pluralize(compositionValidationResult.errors.length, "graph composition error")} for service ${chalk_1.default.blue(serviceName)} on graph ${chalk_1.default.blue(graphName)}`;
                    ...
                    },
                    {
                        ...
                        task: async (ctx, task) => {
                            ...
                            const variables = Object.assign(Object.assign({ id: graphName, tag: flags.tag, gitContext: await git_1.gitInfo(this.log), frontend: flags.frontend || config.engine.frontend }, (historicParameters && { historicParameters })), schemaCheckSchemaVariables);
