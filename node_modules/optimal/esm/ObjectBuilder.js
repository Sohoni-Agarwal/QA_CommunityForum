...
export { ObjectBuilder as default };
export function object(contents, defaultValue) {
  if (contents === void 0) {
    contents = null;
  }
...
export function blueprint(defaultValue) {
  return new ObjectBuilder(builder().notNullable(), defaultValue);
}