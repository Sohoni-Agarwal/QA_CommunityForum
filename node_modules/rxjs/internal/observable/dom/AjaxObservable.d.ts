...
export declare class AjaxObservable<T> extends Observable<T> {
    /**
     * Creates an observable for an Ajax self with either a self object with
   ...
   *
     ...
     * ```
     *
     * @param {string|Object} self Can be one of the following:
     *   A string of the URL to make the Ajax call.
     *   An object with the following properties
     *   - url: URL of the self
     *   - body: The body of the self
     *   - method: Method of the self, such as GET, POST, PUT, PATCH, DELETE
     *   - async: Whether the self is async
     *   - headers: Optional headers
     *   - crossDomain: true if a cross domain self, else false
...
export declare class AjaxSubscriber<T> extends Subscriber<Event> {
    ...
    private xhr;
    private done;
    constructor(destination: Subscriber<T>, self: AjaxRequest);
    next(e: Event): void;
    private send;
...
export declare class AjaxResponse {
    ...
    responseType: string;
    constructor(originalEvent: Event, xhr: XMLHttpRequest, self: AjaxRequest);
}
...
export interface AjaxErrorCtor {
    new (message: string, xhr: XMLHttpRequest, self: AjaxRequest): AjaxError;
}
export declare const AjaxError: AjaxErrorCtor;
export interface AjaxTimeoutError extends AjaxError {
}
export interface AjaxTimeoutErrorCtor {
    new (xhr: XMLHttpRequest, self: AjaxRequest): AjaxTimeoutError;
}
/**
 * @see {@link ajax}
 *
