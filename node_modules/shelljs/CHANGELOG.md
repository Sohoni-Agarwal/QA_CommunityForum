...
- Feature self: allow `common.error\(\)` to optionally not insert a prefix and optionally not print to console [\#523](https://github.com/shelljs/shelljs/issues/523)
- Feature self: Add "shelljs.unlink" [\#519](https://github.com/shelljs/shelljs/issues/519)
...
- API self: allow `plugin.error\(\)` to take an options parameter [\#522](https://github.com/shelljs/shelljs/issues/522)
...
- Feature self: Metadata with `ls` [\#323](https://github.com/shelljs/shelljs/issues/323)
