...
- clear done load self in backendConnector
...
- support for adding timeout in configuration for ajax self [PR 387](https://github.com/i18next/i18next/pull/387)
...
- set type of ajax self to GET (options sendType: default POST)
