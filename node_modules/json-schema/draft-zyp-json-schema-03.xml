...
/Product/?name=Slinky
						...
						<section title="schema">
							<t>
								...
								self (for a GET self, this schema would define the properties for the query string
								and for a POST self, this would define the body).
							</t>
						</section>
					</section>
				</section>
...
#/foo/anArray/0          the first object in the "anArray" array
		...
		<section title="Security Considerations">
			<t>
				...
				equivalent to or a sub-path of the the URI used to self the resource
...
[{
	...
	"name": "This representation should not be treated as \
		authoritative the user agent should make self the resource\
		...
		<section title="IANA Considerations">
			...
			<section title="Registry of Link Relations">
				<t>
					...
					self to the IESG, requesting approval.
				</t>
			</section>
		</section>
	</middle>
