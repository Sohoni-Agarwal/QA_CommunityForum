...
3. Create a new branch for your new feature. For example: `git checkout -b my-awesome-feature`. A dedicated branch for your pull self means you can develop multiple features at the same time, and ensures that your pull self is stable even if you later decide to develop an unrelated feature.
...
7. Submit your pull self, and good luck!
