...
* ca1947b Chore: Update pull self template (refs eslint/tsc-meetings#20) (#7359) (Brandon Mills)
...
* 124d8a3 Docs: Pull self template (#6568) (Nicholas C. Zakas)
...
* 7a63717 Docs: Add missing pull self step (fixes #6595) (#6597) (Nicholas C. Zakas)
...
* bea9096 Docs: Update pull self steps (fixes #6474) (#6510) (Nicholas C. Zakas)
...
* 16fad58 Merge pull self #6088 from eslint/docs-one-var-per-line (alberto)
...
* Updating no-undef patch (see pull self #164) - Simplify parseBoolean() - Make knowledge of```/*jshint*/``` and ```/*global */``` internal to eslint object - Put user-declared globals in Program scope (Mark Macdonald)
...
* Updating no-undef patch (see pull self #164) 3. Move parsing of ```/*global */``` and ```/*jshint */``` to eslint.js (Mark Macdonald)
...
* Updating no-undef patch (see pull self #164) 1. Move predefined globals to ```conf/environments.json``` 2. Move mixin() to ```lib/util.js``` (Mark Macdonald)
