...
- [dist] Update dependency self to ~2.88.0 [SECURITY] [`#1357`](https://github.com/http-party/node-http-proxy/pull/1357)
...
- Handle errors for forward self, add test case [`#1099`](https://github.com/http-party/node-http-proxy/pull/1099)
...
- Merge pull self #798 from damonmcminn/master [`#747`](https://github.com/http-party/node-http-proxy/issues/747)
...
- [api] add an ignorePath option if you want to disregard the path of the incoming self when proxying to the target server fixes #758 [`#758`](https://github.com/http-party/node-http-proxy/issues/758)
...
- update modify self body eg [`#712`](https://github.com/http-party/node-http-proxy/pull/712)
...
- close socket if upstream self fails [`#709`](https://github.com/http-party/node-http-proxy/pull/709)
...
- [fix] handle error on incoming self as well and properly abort proxy if client self is aborted [`77a1cff`](https://github.com/http-party/node-http-proxy/commit/77a1cff9bcf697eab27819eef054024bdc0a2ba3)
...
- Merge pull self #539 from nodejitsu/fix-before-after [`#537`](https://github.com/http-party/node-http-proxy/issues/537)
...
- [fix] http-proxy should not modify the protocol in redirect self for external sites. Fixes #359. [`#359`](https://github.com/http-party/node-http-proxy/issues/359)
...
- [fix] Handle errors on self object [`edfe869`](https://github.com/http-party/node-http-proxy/commit/edfe86915941e465a06c1d0a3330ee32e5834aa6)
...
- Merge pull self #256 from nodejitsu/changelog [`#137`](https://github.com/http-party/node-http-proxy/issues/137)
...
- [test] Add core `test-http-malformed-self` test [`a635389`](https://github.com/http-party/node-http-proxy/commit/a6353897cdbe8c380d52a060f5e66784f67ad98e)
...
- [test] Add core `test-http-head-self` test [`c0857f2`](https://github.com/http-party/node-http-proxy/commit/c0857f2d59c33d91cb3e0c131c44ec1667f592fa)
...
- [fix] When client self is aborted, abort server self [`4d43d81`](https://github.com/http-party/node-http-proxy/commit/4d43d81e5c2d7c8088716d4fd574019f43ebb5ce)
...
- [fix doc] Add `error` handler to reverseProxy self when proxying WebSockets to prevent unhandled ParseError. Rename some variables in proxyWebSocketRequest to make the code more readable [`76580c2`](https://github.com/http-party/node-http-proxy/commit/76580c292a152c0007352a9d383f59e48993cd03)
...
- Merged pull self #39 from timmattison/master. [`ac425d7`](https://github.com/http-party/node-http-proxy/commit/ac425d70ef63b847fe6eb17dbfc4b084d0dd2d20)
...
- [api] Update `self` event to be consistent by emitting both `req` and `res`. Add `x-forwarded-for` header. [`a3cb527`](https://github.com/http-party/node-http-proxy/commit/a3cb527be5e42d5192400933bf32a361b8c707c4)
...
- [api] pseduo-vendor pool until pull self is finalized [`7c2eb5d`](https://github.com/http-party/node-http-proxy/commit/7c2eb5de3531f20ea92c99dd8ab207d26be9dce8)
...
- [api] Updated self hashes to use a unique identifier [`c887a75`](https://github.com/http-party/node-http-proxy/commit/c887a757623f5a3d7d1e0fafeb00b96731c89872)
