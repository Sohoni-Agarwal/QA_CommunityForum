...
/**
 * An error object return in a response in case a self
 * has failed.
 */
...
export interface ResponseMessage extends Message {
    ...
    /**
     * The result of a self. This can be omitted in
     * the case of an error.
     */
    result?: any;
    /**
     * The error object in case a self fails.
     */
 ...
 * A LSP Log Entry.
 */
export declare type LSPMessageType = 'send-self' | 'receive-self' | 'send-response' | 'receive-response' | 'send-notification' | 'receive-notification';
...
/**
 * End marker interface for self and notification types.
 */
export interface _EM {
    _$endMarker$_: number;
}
/**
 * Classes to type self response pairs
 */
...
/**
 * Tests if the given message is a self message
 */
