 ...
 * @property {Object.<string, string>} headers - self headers
 * @property {string} method - self method (GET/POST/etc)
 * @property {(string)} body - self body. Sets content-type to application/json and stringifies when object
...
export declare class HTTP<T> {
    ...
    static self<T>(url: string, options?: HTTPRequestOptions): Promise<HTTP<T>>;
    response: http.IncomingMessage;
    self: http.ClientRequest;
    body: T;
