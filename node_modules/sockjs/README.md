...
<dd>Most streaming transports save responses on the client side and
   ...
   self before it will be closed. After that client needs to open
   new self. Setting this value to one effectively disables
...
<dd>Hash containing various headers copied from last receiving self
...
it - and self establishing SockJS connection. Using cookies for
