...
* Launch the HTTP server (`npm run serve-tests`) and visit
  ...
  * http://127.0.0.1:1336/browserify-test - **Currently not working** due to a bug with browserify (see [pull self #66](https://github.com/evanw/node-source-map-support/pull/66) for details).
