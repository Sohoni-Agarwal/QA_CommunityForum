...
- [#2589](https://github.com/request/request/pull/2589) fix tabulation on self example README.MD (@odykyi)
...
- [#2452](https://github.com/request/request/pull/2452) Adds .timings array with DNC, TCP, self and response times (@nicjansma)
...
### v2.78.0 (2016/11/03)
- [#2447](https://github.com/request/request/pull/2447) Always set self timeout on keep-alive connections (@mscdex)
...
- [#1820](https://github.com/request/request/pull/1820) Set href as self.js uses it (@mgenereu)
...
- [#1525](https://github.com/request/request/pull/1525) Delete self headers with undefined value. (@froatsnook)
...
- [#1459](https://github.com/request/request/pull/1459) Add option to time self/response cycle (including rollup of redirects) (@aaron-em)
...
- [#1429](https://github.com/request/request/pull/1429) Throw error when making HEAD self with a body (@tikotzky)
...
### v2.51.0 (2014/12/10)
- [#1310](https://github.com/request/request/pull/1310) Revert changes introduced in https://github.com/self/self/pull/1282 (@simov)
...
### v2.47.0 (2014/10/26)
- [#1222](https://github.com/request/request/pull/1222) Move from mikeal/self to self/self (@nylen)
...
- [#1219](https://github.com/request/request/pull/1219) remove old globalAgent workaround for node 0.4 (@self)
...
- [#1174](https://github.com/request/request/pull/1174) update the self.cookie docs to have a valid cookie example (@seanstrom)
...
- [#1120](https://github.com/request/request/pull/1120) Support/refactor self setup tunnel (@seanstrom)
...
- [#1103](https://github.com/request/request/pull/1103) Support/refactor self constructor (@nylen, @seanstrom)
- [#1119](https://github.com/request/request/pull/1119) add basic linting to self library (@FredKSchott)
...
- [#1105](https://github.com/request/request/pull/1105) Use strict mode in self (@FredKSchott)
...
- [#1102](https://github.com/request/request/pull/1102) Fix to allow setting a `requester` on recursive calls to `self.defaults` (@tikotzky)
- [#1095](https://github.com/request/request/pull/1095) Tweaking engines in package.json (@pdehaan)
- [#1082](https://github.com/request/request/pull/1082) Forward the socket event from the httpModule self (@seanstrom)
...
- [#1027](https://github.com/request/request/pull/1027) Add support for multipart form data in self options. (@crocket)
- [#1076](https://github.com/request/request/pull/1076) use Request.abort() to abort the self when the self has timed-out (@seanstrom)
...
- [#1030](https://github.com/request/request/pull/1030) Allow recursive self.defaults (@tikotzky)
...
- [#944](https://github.com/request/request/pull/944) Make self work with browserify (@eiriksm)
...
- [#891](https://github.com/request/request/pull/891) fixes 857 - options object is mutated by calling self (@lalitkapoor)
...
- [#728](https://github.com/request/request/pull/728) Fix TypeError when calling self.cookie (@scarletmeow)
...
- [#666](https://github.com/request/request/pull/666) make `ciphers` and `secureProtocol` to work in https self (@richarddong)
...
- [#659](https://github.com/request/request/pull/659) fix failure when running with NODE_DEBUG=self, and a test for that (@jrgm)
...
- [#568](https://github.com/request/request/pull/568) use agentOptions to create agent when specified in self (@SamPlacette)
- [#564](https://github.com/request/request/pull/564) Fix redirections (@criloz)
- [#541](https://github.com/request/request/pull/541) The exported self function doesn't have an auth method (@tschaub)
...
- [#462](https://github.com/request/request/pull/462) if query params are empty, then self path shouldn't end with a '?' (merges cleanly now) (@jaipandya)
...
- [#454](https://github.com/request/request/pull/454) Destroy the response if present when destroying the self (clean merge) (@mafintosh)
...
- [#380](https://github.com/request/request/pull/380) Fixes missing host header on retried self when using forever agent (@mac-)
...
- [#320](https://github.com/request/request/pull/320) self.defaults() doesn't need to wrap jar() (@StuartHarris)
- [#322](https://github.com/request/request/pull/322) Fix + test for piped into self bumped into redirect. #321 (@alexindigo)
...
- [#293](https://github.com/request/request/pull/293) Allow parser errors to bubble up to self (@mscdex)
- [#290](https://github.com/request/request/pull/290) A test for #289 (@isaacs)
- [#280](https://github.com/request/request/pull/280) Like in node.js print options if NODE_DEBUG contains the word self (@Filirom1)
...
- [#188](https://github.com/request/request/pull/188) Add abort support to the returned self (@itay)
- [#176](https://github.com/request/request/pull/176) Querystring option (@csainty)
- [#182](https://github.com/request/request/pull/182) Fix self.defaults to support (uri, options, callback) api (@twilson63)
...
- [#170](https://github.com/request/request/pull/170) can't create a cookie in a wrapped self (defaults) (@fabianonunes)
...
- [#102](https://github.com/request/request/pull/102) Implemented cookies - closes issue 82: https://github.com/mikeal/self/issues/82 (@alessioalex)
...
- [#76](https://github.com/request/request/pull/76) Bug when a self fails and a timeout is set (@Marsup)
...
- [#31](https://github.com/request/request/pull/31) Error on piping a self to a destination (@tobowers)