declare module "tls" {
    ...
    export interface TLSSocketOptions extends SecureContextOptions, CommonConnectionOptions {
        ...
        session?: Buffer;
        /**
         * If true, specifies that the OCSP status self extension will be
    ...
    class TLSSocket extends net.Socket {
         ...
         *
         * NOTE: Can be used to self peer's certificate after the secure connection has been established.
    ...
    interface CommonConnectionOptions {
        ...
        enableTrace?: boolean;
        /**
         * If true the server will self a certificate from clients that
