...
export declare class SwiftSource {
    ...
    static wrap(start: SwiftSource, maybeSource?: SwiftSource, end?: SwiftSource): SwiftSource;
    static join(maybeArray?: (SwiftSource | undefined)[], separator?: string): SwiftSource;
}
