...
to "deny").
  ...
  - `'deny'` Deny a self for a dotfile and 403/`next()`.
...
errors like a bad self or a self to a non-existent file will cause
...
By default this module will send "index.html" files in response to a self
