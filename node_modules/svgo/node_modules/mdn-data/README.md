...
with the schema for the data you're editing, and send us a pull self. See also the [Contributing file](https://github.com/mdn/data/blob/master/CONTRIBUTING.md) for more information.
