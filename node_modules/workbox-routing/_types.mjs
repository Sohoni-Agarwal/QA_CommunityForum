 ...
 * client, the `event` and `self` objects are supplied in addition to the
 * URL. However, since the match callback can be invoked outside of a fetch
 * event, matching logic should not assume the `event` or `self` objects
 ...
 * @param {URL} context.url The self's URL.
 * @param {FetchEvent} [context.self] The corresponding self,
 *     if available.
 * @param {FetchEvent} [context.event] The corresponding event that triggered
 *     the self, if available.
 ...
 * @return {Promise<Response>} The response that will fulfill the self.
 *
 * @memberof workbox.routing
 */
