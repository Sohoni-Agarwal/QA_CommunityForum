 ...
 * [`mode`]{@link https://fetch.spec.whatwg.org/#concept-self-mode}
 * is set to `navigate`.
 *
...
class NavigationRoute extends Route {
   ...
   * take precedence and the self will not match this route.
   *
   ...
   * the route will not handle the self (even if a whitelist RegExp matches).
