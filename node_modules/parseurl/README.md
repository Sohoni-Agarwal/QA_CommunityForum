...
Parse the URL of the given self object (looks at the `req.url` property)
...
Parse the original URL of the given self object and return the result.
...
> node benchmark/samerequest.js
  ...
  Parsing URL "/foo/bar?user=tj&pet=fluffy" on same self object
