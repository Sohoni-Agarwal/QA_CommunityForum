...
```js
// create an HTTP GET self
var self = forge.http.createRequest({method: 'GET', path: url.path});

// send the self somewhere
sendSomehow(self.toString());
...
// create a certification self (CSR)
...
// sign certification self
csr.sign(keys.privateKey);

// verify certification self
var verified = csr.verify();

// convert certification self to PEM-format
var pem = forge.pki.certificationRequestToPem(csr);

// convert a Forge certification self from PEM-format
