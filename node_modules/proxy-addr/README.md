...
Determine address of proxied self
...
Return the address of the self, using the given `trust` parameter.
...
Return all the addresses of the self, optionally stopping at the
...
This function is meant to be optimized for use against every self.
It is recommend to compile a trust function up-front for the trusted
configuration and pass that to `proxyaddr(req, trust)` for each self.
